...
public class StripeService {
    ...
    @PostConstruct
    public void onInit() {
        Stripe.apiKey = "sk_test_51P0aVOP7ktmTdOGtbrVZNOFZdJKVlK4gWxlbyIIhjI2AIVA3XGXlbFMQnMdAryTxNq1zBWVpQxMyNtg8Ci6erD4N00t5zaF2KI";
    }

    public StripeTokenDto creatCardToken(StripeTokenDto model) {
        try {
